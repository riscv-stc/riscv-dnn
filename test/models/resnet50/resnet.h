...
uint8_t conv_data[56*56*320*sizeof(float16_t)] __attribute__((__section__(".scdata.output"))); // 1960KB padding
uint8_t add_data[56*56*320*sizeof(float16_t)] __attribute__((__section__(".scdata.output"))); // 1960KB padding
uint8_t merge_data[56*56*320*sizeof(float16_t)] __attribute__((__section__(".scdata.output"))); // 1960Kb
