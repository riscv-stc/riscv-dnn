...
*/
    ...
    for (int i = 0; i < pics; i++) {
        ...
        tensor_new_3d(stage0_conv_out, stage0_conv.hout, stage0_conv.wout, stage0_conv.cout, DATASIZE, conv2d_data);
...
*/
    ...
    for (int i = 0; i < pics/2; i++) {        
        ...
        tensor_new_3d_with_stride(stage1_conv1_out, stage1_conv1.hout, stage1_conv1.wout, stage1_conv1.cout, DATASIZE, conv2d_1_data[pid/ncores1], stage1_conv1.cout * DATASIZE + CACHELINE);
        conv_ncores(&stage1_conv1_out, &stage0_relu_out, conv2d_1_kernel_data, stage1_conv1, 0, ncores1, pid);

        tensor_new_3d(stage1_1_relu_out, stage1_conv2.hout, stage1_conv2.wout, stage1_conv2.cout, DATASIZE, Relu_1_data[pid/ncores1]);
        ...
        tensor_new_3d(stage1_2_relu_out, stage1_conv3.hout, stage1_conv3.wout, stage1_conv3.cout, DATASIZE, Relu_2_data[pid/ncores1]);
        ...
        tensor_new_3d_with_stride(stage1_3_relu_out, stage1_conv4.hout, stage1_conv4.wout, stage1_conv4.cout, DATASIZE, Relu_3_data[pid/ncores1], stage1_conv4.cout * DATASIZE + CACHELINE);
        tensor_new_3d_with_stride(stage1_add_out, stage1_conv4.hout, stage1_conv4.wout, stage1_conv4.cout, DATASIZE, add_data[pid/ncores1], stage1_conv4.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d(stage1_4_relu_out, stage1_conv5.hout, stage1_conv5.wout, stage1_conv5.cout, DATASIZE, Relu_4_data[pid/ncores1]);
        ...
        tensor_new_3d(stage1_5_relu_out, stage1_conv6.hout, stage1_conv6.wout, stage1_conv6.cout, DATASIZE, Relu_5_data[pid/ncores1]);
        ...
        tensor_new_3d_with_stride(stage1_add1_out, stage1_conv7.hout, stage1_conv7.wout, stage1_conv7.cout, DATASIZE, add_1_data[pid/ncores1], stage1_conv7.cout * DATASIZE + CACHELINE);
        tensor_new_3d_with_stride(stage1_6_relu_out, stage1_conv7.hout, stage1_conv7.wout, stage1_conv7.cout, DATASIZE, Relu_6_data[pid/ncores1], stage1_conv7.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d(stage1_7_relu_out, stage1_conv8.hout, stage1_conv8.wout, stage1_conv8.cout, DATASIZE, Relu_7_data[pid/ncores1]);
        ...
        tensor_new_3d(stage1_8_relu_out, stage1_conv9.hout, stage1_conv9.wout, stage1_conv9.cout, DATASIZE, Relu_8_data[pid/ncores1]);
        ...
        tensor_new_3d_with_stride(stage1_add2_out, stage1_conv10.hout, stage1_conv10.wout, stage1_conv10.cout, DATASIZE, add_2_data[pid/ncores1], stage1_conv10.cout * DATASIZE + CACHELINE);
...
*/
    ...
    for(int i = 0; i < pics/4; i++) {
        ...
        tensor_new_3d_with_stride(stage2_conv11_out, stage2_conv11.hout, stage2_conv11.wout, stage2_conv11.cout, DATASIZE, conv2d_11_data[pid/ncores2], stage2_conv11.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage2_10_relu_out, stage2_conv12.hout, stage2_conv12.wout, stage2_conv12.cout, DATASIZE, Relu_10_data[pid/ncores2], stage2_conv12.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage2_11_relu_out, stage2_conv13.hout, stage2_conv13.wout, stage2_conv13.cout, DATASIZE, Relu_11_data[pid/ncores2], stage2_conv13.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage2_add3_out, stage2_conv14.hout, stage2_conv14.wout, stage2_conv14.cout, DATASIZE, add_3_data[pid/ncores2], stage2_conv14.cout * DATASIZE + CACHELINE);
        tensor_new_3d_with_stride(stage2_12_relu_out, stage2_conv14.hout, stage2_conv14.wout, stage2_conv14.cout, DATASIZE, Relu_12_data[pid/ncores2], stage2_conv14.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage2_13_relu_out, stage2_conv15.hout, stage2_conv15.wout, stage2_conv15.cout, DATASIZE, Relu_13_data[pid/ncores2], stage2_conv15.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage2_14_relu_out, stage2_conv16.hout, stage2_conv16.wout, stage2_conv16.cout, DATASIZE, Relu_14_data[pid/ncores2], stage2_conv16.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage2_add4_out, stage2_conv17.hout, stage2_conv17.wout, stage2_conv17.cout, DATASIZE, add_4_data[pid/ncores2], stage2_conv17.cout * DATASIZE + CACHELINE);
        tensor_new_3d_with_stride(stage2_15_relu_out, stage2_conv17.hout, stage2_conv17.wout, stage2_conv17.cout, DATASIZE, Relu_15_data[pid/ncores2], stage2_conv17.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage2_16_relu_out, stage2_conv18.hout, stage2_conv18.wout, stage2_conv18.cout, DATASIZE, Relu_16_data[pid/ncores2], stage2_conv18.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage2_17_relu_out, stage2_conv19.hout, stage2_conv19.wout, stage2_conv19.cout, DATASIZE, Relu_17_data[pid/ncores2], stage2_conv19.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage2_add5_out, stage2_conv20.hout, stage2_conv20.wout, stage2_conv20.cout, DATASIZE, add_5_data[pid/ncores2], stage2_conv20.cout * DATASIZE + CACHELINE);
        tensor_new_3d_with_stride(stage2_18_relu_out, stage2_conv20.hout, stage2_conv20.wout, stage2_conv20.cout, DATASIZE, Relu_18_data[pid/ncores2], stage2_conv20.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage2_19_relu_out, stage2_conv21.hout, stage2_conv21.wout, stage2_conv21.cout, DATASIZE, Relu_19_data[pid/ncores2], stage2_conv21.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage2_20_relu_out, stage2_conv22.hout, stage2_conv22.wout, stage2_conv22.cout, DATASIZE, Relu_20_data[pid/ncores2], stage2_conv22.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage2_add6_out, stage2_conv23.hout, stage2_conv23.wout, stage2_conv23.cout, DATASIZE, add_6_data[pid/ncores2], stage2_conv23.cout * DATASIZE + CACHELINE);
...
*/
    ...
    for (int i = 0; i < pics/8; i++) {
        ...
        tensor_new_3d_with_stride(stage3_22_relu_out, stage3_conv25.hout, stage3_conv25.wout, stage3_conv25.cout, DATASIZE, Relu_22_data[pid], stage3_conv25.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage3_23_relu_out, stage3_conv26.hout, stage3_conv26.wout, stage3_conv26.cout, DATASIZE, Relu_23_data[pid], stage3_conv26.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage3_add7_out, stage3_conv27.hout, stage3_conv27.wout, stage3_conv27.cout, DATASIZE, add_7_data[pid], stage3_conv27.cout * DATASIZE + CACHELINE);
        tensor_new_3d_with_stride(stage3_24_relu_out, stage3_conv27.hout, stage3_conv27.wout, stage3_conv27.cout, DATASIZE, Relu_24_data[pid], stage3_conv27.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage3_25_relu_out, stage3_conv28.hout, stage3_conv28.wout, stage3_conv28.cout, DATASIZE, Relu_25_data[pid], stage3_conv28.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage3_26_relu_out, stage3_conv29.hout, stage3_conv29.wout, stage3_conv29.cout, DATASIZE, Relu_26_data[pid], stage3_conv29.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage3_add8_out, stage3_conv30.hout, stage3_conv30.wout, stage3_conv30.cout, DATASIZE, add_8_data[pid], stage3_conv30.cout * DATASIZE + CACHELINE);
        tensor_new_3d_with_stride(stage3_27_relu_out, stage3_conv30.hout, stage3_conv30.wout, stage3_conv30.cout, DATASIZE, Relu_27_data[pid], stage3_conv30.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage3_28_relu_out, stage3_conv31.hout, stage3_conv31.wout, stage3_conv31.cout, DATASIZE, Relu_28_data[pid], stage3_conv31.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage3_29_relu_out, stage3_conv32.hout, stage3_conv32.wout, stage3_conv32.cout, DATASIZE, Relu_29_data[pid], stage3_conv32.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage3_add9_out, stage3_conv33.hout, stage3_conv33.wout, stage3_conv33.cout, DATASIZE, add_9_data[pid], stage3_conv33.cout * DATASIZE + CACHELINE);
        tensor_new_3d_with_stride(stage3_30_relu_out, stage3_conv33.hout, stage3_conv33.wout, stage3_conv33.cout, DATASIZE, Relu_30_data[pid], stage3_conv33.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage3_31_relu_out, stage3_conv34.hout, stage3_conv34.wout, stage3_conv34.cout, DATASIZE, Relu_31_data[pid], stage3_conv34.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage3_32_relu_out, stage3_conv35.hout, stage3_conv35.wout, stage3_conv35.cout, DATASIZE, Relu_32_data[pid], stage3_conv35.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage3_add10_out, stage3_conv36.hout, stage3_conv36.wout, stage3_conv36.cout, DATASIZE, add_10_data[pid], stage3_conv36.cout * DATASIZE + CACHELINE);
        tensor_new_3d_with_stride(stage3_33_relu_out, stage3_conv36.hout, stage3_conv36.wout, stage3_conv36.cout, DATASIZE, Relu_33_data[pid], stage3_conv36.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage3_34_relu_out, stage3_conv37.hout, stage3_conv37.wout, stage3_conv37.cout, DATASIZE, Relu_34_data[pid], stage3_conv37.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage3_35_relu_out, stage3_conv38.hout, stage3_conv38.wout, stage3_conv38.cout, DATASIZE, Relu_35_data[pid], stage3_conv38.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage3_add11_out, stage3_conv39.hout, stage3_conv39.wout, stage3_conv39.cout, DATASIZE, add_11_data[pid], stage3_conv39.cout * DATASIZE + CACHELINE);
        tensor_new_3d_with_stride(stage3_36_relu_out, stage3_conv39.hout, stage3_conv39.wout, stage3_conv39.cout, DATASIZE, Relu_36_data[pid], stage3_conv39.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage3_37_relu_out, stage3_conv40.hout, stage3_conv40.wout, stage3_conv40.cout, DATASIZE, Relu_37_data[pid], stage3_conv40.cout * DATASIZE + CACHELINE);
        ...
        tensor_new_3d_with_stride(stage3_38_relu_out, stage3_conv41.hout, stage3_conv41.wout, stage3_conv41.cout, DATASIZE, Relu_38_data[pid], stage3_conv41.cout * DATASIZE + CACHELINE);
