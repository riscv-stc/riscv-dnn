...
if simulator == 'spike':
    opt_levels = {"16": "-O2 -D__RVM__ -DNLOOPS=1"}
...
def test(num, params, defs):
    ...
    # get_golden_check(num, "resnet_model/Relu_10", BATCH)
...
if __name__ == "__main__" :
    ...
    do_test(params, opt_levels, test, title, simulator, simulator!='spike', ncores)
