...
#define STAGE1_SIZE 2007040 // 56*56*320*sizeof(float16_t)
#define STAGE2_SIZE 1204224 // 56*56*192*sizeof(float16_t)
#define STAGE3_SIZE 501760  // 28*28*320*sizeof(float16_t)
#define STAGE4_SIZE 225792  // 14*14*576*sizeof(float16_t)

uint8_t conv_data[56*56*320*sizeof(float16_t)*3] __attribute__((__section__(".scdata.output"))); // 1960KB padding
uint8_t add_data[56*56*320*sizeof(float16_t)*3] __attribute__((__section__(".scdata.output"))); // 1960KB padding
uint8_t merge_data[56*56*320*sizeof(float16_t)*3] __attribute__((__section__(".scdata.output"))); // 1960Kb
...
// uint8_t Relu_10_data[4][56*56*128*sizeof(float16_t)] __attribute__((__section__(".scdata.output")));
...
// uint8_t Relu_13_data[4][28*28*128*sizeof(float16_t)] __attribute__((__section__(".scdata.output")));
