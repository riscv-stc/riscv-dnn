...
uint8_t Relu_9_data[16][56*56*256*sizeof(float16_t)] __attribute__((__section__(".scdata.output")));
...
uint8_t Relu_21_data[16][28*28*512*sizeof(float16_t)] __attribute__((__section__(".scdata.output")));
