...
# opt_levels = {"im2col14":"-O2 -DNLOOPS=14 -D__IM2COL__", "im2col24":"-O2 -DNLOOPS=24 -D__IM2COL__"}
opt_levels = {"im2col":"-O2 -D__IM2COL__"}
...
def conv_add_bn_relu(num, hin, win, cin, cout, kh, kw, sh=1, sw=1, dh=1, dw=1, pt=0, pb=0, pl=0, pr=0):
    ...
    vsadd.tofile(f"build/{num}/addsrc.bin")
