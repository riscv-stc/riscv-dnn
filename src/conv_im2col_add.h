...
static inline int conv_im2col_add(Tensor *dst, Tensor *src, Tensor *weight, Config *ss)
{
...
static inline int im2col_add(Tensor *dst, Tensor *src, Tensor *weight, Config *ss, int skh, int skw)
{
    int stride_h = ss->stride_h;
    int stride_w = ss->stride_w;
