#ifndef __CONV_IM2COL_INT_H__
#define __CONV_IM2COL_INT_H__
...
static inline int conv_int16(Tensor *dst, Tensor *src, Tensor *weight, Config *ss)
{
    ...
    int16_t *psrc1 = (int16_t *)src->data;
    int16_t *psrc2 = (int16_t *)weight->data;
    int16_t *pdst = (int16_t *)dst->data;
