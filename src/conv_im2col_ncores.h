...
static inline int conv_ncores_cout_cin(Tensor *dst, Tensor *src, Tensor *weight, Config *ss, int ncores, int pid)
{
...
static inline int conv_ncores_hout(Tensor *dst, Tensor *src, Tensor *weight, Config *ss, int ncores, int pid)
{
    ...
    conv_im2col(&_dstMat, &_srcMat, weight, &_sst);
    
    return 0;
}

static inline int conv_ncores_hout_small_cin(Tensor *dst, Tensor *src, Tensor *weight, Config *ss, int ncores, int pid)
{
    int stride_h = ss->stride_h;
    int stride_w = ss->stride_w;
    ...
    conv_im2col_small_cin(&_dstMat, &_srcMat, weight, &_sst);
    
    return 0;
}


static inline int conv_ncores_hout_cout(Tensor *dst, Tensor *src, Tensor *weight, Config *ss, int ncores, int pid)
{
    int stride_h = ss->stride_h;
    int stride_w = ss->stride_w;
...
static inline int conv_ncores_cin_cout(Tensor *dst, Tensor *src, Tensor *weight, Config *ss, int ncores, int pid)
{
    int stride_h = ss->stride_h;
    int stride_w = ss->stride_w;
